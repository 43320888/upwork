(() => {
	...
	e.style.innerHTML = `
		...
		.appSlotMachine777theMostUniqueName {
			...
			/* background-image: url(wrapper1.jpg); */
			/* background-image: url(wrapper3.jpg); */
			/* background-image: url(wrapper5.jpg); */
			/* background-image: url(wrapper8.jpg); */
		...
		.appSlotMachine777theMostUniqueName div:first-child {
			...
			/* background-image: url(title8.png); */
			background-position-x: center;
		...
		.appSlotMachine777theMostUniqueName #canvasSlotMachine777theMostUniqueName {
			...
			/* background-image: url(table5.png); */
			/* background-image: url(table8.jpg); */
		}
