...
document.getElementsByClassName('spin-table')[0].firstElementChild.style.marginTop = document.getElementsByClassName('spin-table')[0].style.height - document.getElementsByClassName('spin-table')[0].firstElementChild.clientHeight / 2;
