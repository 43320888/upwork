(() => {
	...
	function setSize() {
		...
		/* CANVASWRAPPER */
		/* top, left, width, height */
		if (sizes.wrapper.w > sizes.wrapper.h) {
			...
			sizes.canvasWrapper = sizes.wrapper.w * 0.7;
			e.canvaswrapper.style.width = `${sizes.canvasWrapper}px`;
			e.canvaswrapper.style.top = `${sizes.wrapper.h / 2 - sizes.canvasWrapper / 2}px`;
			e.canvaswrapper.style.top = `${sizes.wrapper.h / 2 - sizes.wrapper.w * 0.7 / 2}px`;
		}
		// max-with 777px
