(() => {
	...
	function setSize() {
		...
		if (sizes.wrapper.w > sizes.wrapper.h || sizes.wrapper.w * 100 / sizes.wrapper.h > 80) {
			...
			sizes.canvasWrapper.w = sizes.wrapper.h * 0.9;
			sizes.canvasWrapper.t = sizes.wrapper.h * 0.1 + (sizes.wrapper.h / 2 - sizes.canvasWrapper / 2);
			sizes.canvasWrapper.l = sizes.wrapper.w / 2 - sizes.canvasWrapper / 2;
		}
