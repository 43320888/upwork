(() => {
	...
	function setSize() {
		...
		e.pin.style.width = `${sizes.canvasWrapper.w / 10}px`;
		e.pin.style.height = `${sizes.canvasWrapper.w / 10}px`;
		debugger;
		e.pin.style.top = `${sizes.canvasWrapper.top - sizes.canvasWrapper.w / 20}px`;
		// e.pin.style.left = `${}px`;
